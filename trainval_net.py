...
from lib.model.utils.config import cfg, cfg_from_file, cfg_from_list, get_output_dir,_merge_a_into_b
...
from forward_net import eval_result
...
if __name__ == '__main__':
    ...
    if "pascal_voc" in args.dataset:
        ...
        elif args.dataset in  ["pascal_voc", "pascal_voc_07"]:
    ...
    imdb, roidb = combined_roidb(args.imdb_name, root_path=args.data_root)
    ...
    if args.use_tfboard:
        ...
        logger = SummaryWriter(os.path.join(output_dir, args.logdir))

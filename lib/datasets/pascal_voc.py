...
class pascal_voc(imdb):
    def __init__(self, image_set, year, root_path=None):
        imdb.__init__(self, 'voc_' + year + '_' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = self._get_default_path() if root_path is None \
            else root_path
    ...
    def _get_cache(self):
        return os.path.join(self._devkit_path, 'cache')
